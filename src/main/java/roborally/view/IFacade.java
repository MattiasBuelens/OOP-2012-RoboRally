...
public interface IFacade<Board, Robot, Wall, Battery, RepairKit, SurpriseBox> {
	...
	/**
	 * Return the set of batteries possessed by a robot.
	 * 
	 * @note This is part of our graphical user interface extensions.
	 */
	public Set<Battery> getRobotBatteries(Robot robot);
	
	/**
	 * Return the set of repair kits possessed by a robot.
	 * 
	 * @note This is part of our graphical user interface extensions.
	 */
	...
	/**
	 * Return the set of surprise boxes possessed by a robot.
	 * 
	 * @note This is part of our graphical user interface extensions.
	 */
